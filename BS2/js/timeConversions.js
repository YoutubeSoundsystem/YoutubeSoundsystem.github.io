function convertTime(input) {
        ...
        if (reptms.test(input)) {
        	...
        	if (hours != 0 && minutes == 0){
                ...
                final = formatHours+":0"+formatMinutes+":"+formatSeconds;
            }
            else if (hours != 0 && minutes > 9){
                final = formatHours+":"+formatMinutes+":"+formatSeconds;
            }
        	else{
...
function convertToDuration(seconds){
    ...
    else if(hours > 0){ hourString = hours; }
...
function convertToRawSeconds(input) {
    ...
    if (nums.length == 1){
        ...
        return (parseInt(nums[0]*3600 + parseInt(nums[1]*60 + parseInt(nums[2]))));
    }
}